...
{
    // PS: This way of extracting the Facebook token is currently not working
    public static class FacebookHelper
    {
        ...
        public static string GetFacebookToken(string email, string password)
        {
            ...
            return browserHtml.Substring(indexFrom, indexTo - indexFrom);
        }
    }
}
